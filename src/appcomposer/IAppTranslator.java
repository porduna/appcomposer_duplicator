...
public interface IAppTranslator {
	 ...
	 */
	Map<String, String> translate(String url, String lang, String targetAge) throws AppComposerException;
	
	/**
	 * Wrapper of the {@link #translate(String, String, String)} method, where bundle
	 * is lang + "_" + targetAge.
	 * 
	 * @param url The app to be translated.
	 ...
	 * @return A map with the translations or null if the translation is not found.
	 */
	Map<String, String> translate(String url, String bundle) throws AppComposerException;
